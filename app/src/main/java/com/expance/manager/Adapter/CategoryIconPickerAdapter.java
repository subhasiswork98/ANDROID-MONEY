...
public class CategoryIconPickerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<Integer> arrayList = DataHelper.getCategoryIcons();
    String color;
    Context context;
    int icon;
    ...
    public CategoryIconPickerAdapter(Context context, String color) {
    ...
    private class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (CategoryIconPickerAdapter.this.listener != null) {
                CategoryIconPickerAdapter.this.listener.itemClick(view, getLayoutPosition());
            }
        }
    }
