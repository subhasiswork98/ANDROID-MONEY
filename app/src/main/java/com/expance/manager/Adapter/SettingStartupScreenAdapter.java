...
public class SettingStartupScreenAdapter extends BaseAdapter {
    ...
    public SettingStartupScreenAdapter(Context context, List<String> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int startUpScreen = SharePreferenceHelper.getStartUpScreen(this.context);
        viewHolder.radioButton.setText(str);
        if (startUpScreen == position) {
